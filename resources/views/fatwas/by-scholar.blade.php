...
@section('title', 'فتاوى ' . $scholar->name)

@section('content')
<div class="container py-5">
    <!-- Scholar Header -->
    <div class="scholar-header-section mb-5">
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="d-flex align-items-center mb-3">
                    <div class="scholar-avatar-small me-3">
                        <i class="fas fa-user-graduate"></i>
                    </div>
                    <div>
                        <h1 class="mb-1" style="color: #1d8a4e;">فتاوى {{ $scholar->name }}</h1>
                        <p class="text-muted mb-0">عالم وداعية إسلامي</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 text-end">
                <a href="{{ route('scholars.show', $scholar->id) }}" class="btn btn-outline-success">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="stat-card">
                    ...
                    <div>
                        <h3 style="color: #1d8a4e;">{{ number_format($stats['answered']) }}</h3>
                        <p class="text-muted mb-0">الفتاوى المجابة</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    @else
        <div class="empty-state text-center py-5">
            ...
            <p class="text-muted">لم يتم نشر أي فتاوى لهذا العالم بعد</p>
